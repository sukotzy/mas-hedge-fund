...
parser = argparse.ArgumentParser(description="Run Qwen Experiment over a date range.")
...
parser.add_argument("--output-dir", type=str, default="data/training_output_qwen_2020h1", help="Output directory")
