...
def main():
    ...
    fig.suptitle('Awakening Loss Aversion: Exposure & Cash Hoarding during Crises', fontsize=20, fontweight='bold', y=0.98)
    
    # Absolute strict mathematical positioning mapping for 1x4 horizontal strips
    plt.subplots_adjust(bottom=0.20, top=0.82, wspace=0.15)
