...
& "d:\2025-2026A\Thesis-MAS Hedge Fund\projects\hf with antigravity\mas-hedge-fund\hf2\Scripts\python.exe" src/selection/factor_db.py --start_year 2023 --limit 10
...
if ($LASTEXITCODE -eq 0) {
    ...
    & "d:\2025-2026A\Thesis-MAS Hedge Fund\projects\hf with antigravity\mas-hedge-fund\hf2\Scripts\python.exe" verify_selection_output.py
} else {
