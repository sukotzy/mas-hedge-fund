...
& $python evaluate_experiments.py `
 ...
 --output deepseek_4_settings_comparison_rm1.png
...
& $python evaluate_experiments.py `
 ...
 --output deepseek_4_settings_comparison_rm2.png
...
& $python evaluate_experiments.py `
 ...
 --output deepseek_4_settings_comparison_rm3.png
...
& $python evaluate_experiments.py `
 ...
 --output qwen_4_settings_comparison_rm1.png
...
& $python evaluate_experiments.py `
 ...
 --output qwen_4_settings_comparison_rm2.png
...
& $python evaluate_experiments.py `
 ...
 --output qwen_4_settings_comparison_rm3.png
...
& $python evaluate_experiments.py `
 ...
 --title "DeepSeek Hedge Fund Strategy Comparison - 2020 Covid Crash" `
 --output deepseek_4_settings_comparison_no_rm1.png
...
& $python evaluate_experiments.py `
 ...
 --labels "Standard+No Hint" "Wealth+No Hint" "Standard+Hint" "Wealth+Hint" `
 --title "DeepSeek Hedge Fund Strategy Comparison - 2022 Rate Hike" `
 --output deepseek_4_settings_comparison_no_rm2.png
...
& $python evaluate_experiments.py `
 ...
 --labels "Standard+No Hint" "Wealth+No Hint" "Standard+Hint" "Wealth+Hint" `
 --title "DeepSeek Hedge Fund Strategy Comparison - 2023 SVB Collapse" `
 --output deepseek_4_settings_comparison_no_rm3.png
...
& $python evaluate_experiments.py `
 ...
 --labels "Standard+No Hint" "Wealth+No Hint" "Standard+Hint" "Wealth+Hint" `
 --title "Qwen Hedge Fund Strategy Comparison - 2020 Covid Crash" `
 --output qwen_4_settings_comparison_no_rm1.png
...
& $python evaluate_experiments.py `
 ...
 --labels "Standard+No Hint" "Wealth+No Hint" "Standard+Hint" "Wealth+Hint" `
 --title "Qwen Hedge Fund Strategy Comparison - 2022 Rate Hike" `
 --output qwen_4_settings_comparison_no_rm2.png
...
& $python evaluate_experiments.py `
 ...
 --labels "Standard+No Hint" "Wealth+No Hint" "Standard+Hint" "Wealth+Hint" `
 --title "Qwen Hedge Fund Strategy Comparison - 2023 SVB Collapse" `
 --output qwen_4_settings_comparison_no_rm3.png
